...
HD_PWD='C:/Users/david/Desktop/workspace/tmtmmtmtm/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ece_520_pmod_led_switch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ece_520_pmod_led_switch.tcl
