...
HD_PWD='C:/Users/david/Desktop/workspace/tmtmmtmtm/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ece_520_pmod_led_switch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ece_520_pmod_led_switch.tcl -notrace
